                                    ...
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <center data-parsed="">
                                                        <a href="{{ URL('/') }}" align="center" class="text-center">
                                                            <img src="{{ asset('images/logo.png') }}" class="swu-logo" alt="Logo">
                                                        </a>
                                                    </center>
                                                </th>
                                                <th class="expander"></th>
                            ...
                            <table class="row grey"><tbody><tr>
                                    <th class="small-12 large-12 columns first last">
                                        <table>
                                            <tr>
                                                <th>
                                                    <p class="text-center footercopy">&#xA9; Copyright @ {{ date('Y') }} Torcoroma SA. All Rights Reserved</p>
                                                </th>
                                                <th class="expander"></th>
                                            </tr>
                                        </table>
