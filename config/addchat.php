...
return [
     ...
     *
    */
    'widget_name'           => 'Torcoroma WEB CHAT',
    ...
    'widget_footer_text'    => 'Torcoroma WEB by Kronnos',
    'widget_footer_url'     => 'https://www.facebook.com/kronnosco.la',
    ...
    */
     ...
     * with the guests. You can create a seperate User Group and add that group's id.
     *
     * e.g
     *
     * guest_group_id = 8
    ...
    */
     ...
     * Whether to show users email in throughout the widget.
     *
    ...
    */
     ...
     *
     * When enabled, AddChat migrations managed automatically on running migration command.
     * AddChat migrations will autorun even when updating to a new AddChat version.
     * When updating AddChat, AddChat migrations will auto-run on running migration command
     * and it'll update it's database tables without losing or modifying existing data in DB.
     *
     * If it's FALSE (disabled)
     *
     * You'll need to copy AddChat migrations files to your app migrations folder.
     * Then, you can manage the migration files yourself.
     * This will be the case when you're customizing the AddChat on your own.
     *
    */
